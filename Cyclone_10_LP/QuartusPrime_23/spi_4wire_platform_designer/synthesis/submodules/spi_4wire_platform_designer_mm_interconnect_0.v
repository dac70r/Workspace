// spi_4wire_platform_designer_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module spi_4wire_platform_designer_mm_interconnect_0 (
	...
	wire  [88:0] spi_0_spi_control_port_agent_rf_source_data;                                        // spi_0_spi_control_port_agent:rf_source_data -> spi_0_spi_control_port_agent_rsp_fifo:in_data
	...
	wire  [88:0] spi_0_spi_control_port_agent_rsp_fifo_out_data;                                     // spi_0_spi_control_port_agent_rsp_fifo:out_data -> spi_0_spi_control_port_agent:rf_sink_data
	...
	wire  [87:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> spi_0_spi_control_port_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // spi_0_spi_control_port_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [3:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> spi_0_spi_control_port_agent:cp_channel
	...
	wire  [87:0] spi_0_spi_control_port_agent_rp_data;                                               // spi_0_spi_control_port_agent:rp_data -> router_005:sink_data
	...
	spi_4wire_platform_designer_mm_interconnect_0_router router (
	...
	spi_4wire_platform_designer_mm_interconnect_0_router_001 router_001 (
	...
	spi_4wire_platform_designer_mm_interconnect_0_router_002 router_002 (
	...
	spi_4wire_platform_designer_mm_interconnect_0_router_003 router_003 (
	...
	spi_4wire_platform_designer_mm_interconnect_0_router_003 router_004 (
	...
	spi_4wire_platform_designer_mm_interconnect_0_router_002 router_005 (
	...
	spi_4wire_platform_designer_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	spi_4wire_platform_designer_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	spi_4wire_platform_designer_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	spi_4wire_platform_designer_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	spi_4wire_platform_designer_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	spi_4wire_platform_designer_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	spi_4wire_platform_designer_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	spi_4wire_platform_designer_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	spi_4wire_platform_designer_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	spi_4wire_platform_designer_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	spi_4wire_platform_designer_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	spi_4wire_platform_designer_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	spi_4wire_platform_designer_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
