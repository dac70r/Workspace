...
#include "../imported_source/ecatfoe.h"
#include "../imported_source/ecatslv.h"

#define _FOEAPPL_ 1
    #include "../imported_source/foeappl.h"
#undef _FOEAPPL_
#define _FOEAPPL_ 0

#include "../imported_source/bootmode.h"



#include "../imported_source/applInterface.h"
