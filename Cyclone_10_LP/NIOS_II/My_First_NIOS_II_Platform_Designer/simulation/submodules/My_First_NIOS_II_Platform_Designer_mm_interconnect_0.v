...
module My_First_NIOS_II_Platform_Designer_mm_interconnect_0 (
	...
	wire   [6:0] rsp_mux_src_channel;                                                             // rsp_mux:src_channel -> HelloNios_data_master_agent:rp_channel
	...
	wire   [6:0] rsp_mux_001_src_channel;                                                         // rsp_mux_001:src_channel -> HelloNios_instruction_master_agent:rp_channel
	...
	wire   [6:0] cmd_mux_001_src_channel;                                                         // cmd_mux_001:src_channel -> HelloNios_debug_mem_slave_agent:cp_channel
	...
	wire   [6:0] cmd_mux_002_src_channel;                                                         // cmd_mux_002:src_channel -> SRAM_s1_agent:cp_channel
	...
	wire   [6:0] cmd_mux_003_src_channel;                                                         // cmd_mux_003:src_channel -> GPIO_s1_agent:cp_channel
	...
	wire  [90:0] timer_s1_agent_rf_source_data;                                                   // TIMER_s1_agent:rf_source_data -> TIMER_s1_agent_rsp_fifo:in_data
	...
	wire  [90:0] timer_s1_agent_rsp_fifo_out_data;                                                // TIMER_s1_agent_rsp_fifo:out_data -> TIMER_s1_agent:rf_sink_data
	...
	wire  [89:0] cmd_mux_004_src_data;                                                            // cmd_mux_004:src_data -> TIMER_s1_agent:cp_data
	...
	wire  [89:0] cmd_mux_005_src_data;                                                            // cmd_mux_005:src_data -> pio_0_s1_agent:cp_data
	...
	wire  [90:0] spi_0_spi_control_port_agent_rf_source_data;                                     // spi_0_spi_control_port_agent:rf_source_data -> spi_0_spi_control_port_agent_rsp_fifo:in_data
	...
	wire  [90:0] spi_0_spi_control_port_agent_rsp_fifo_out_data;                                  // spi_0_spi_control_port_agent_rsp_fifo:out_data -> spi_0_spi_control_port_agent:rf_sink_data
	...
	wire  [89:0] cmd_mux_006_src_data;                                                            // cmd_mux_006:src_data -> spi_0_spi_control_port_agent:cp_data
	...
	wire  [89:0] timer_s1_agent_rp_data;                                                          // TIMER_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [89:0] pio_0_s1_agent_rp_data;                                                          // pio_0_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [89:0] spi_0_spi_control_port_agent_rp_data;                                            // spi_0_spi_control_port_agent:rp_data -> router_008:sink_data
