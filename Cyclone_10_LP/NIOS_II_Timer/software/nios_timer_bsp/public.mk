...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../my_timer.sopcinfo
...
# The SOPC System ID 
# setting SOPC_SYSID is 74565
SOPC_SYSID_FLAG += --id=74565
ELF_PATCH_FLAG  += --id 74565
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1729857215
SOPC_SYSID_FLAG += --timestamp=1729857215
ELF_PATCH_FLAG  += --timestamp 1729857215
