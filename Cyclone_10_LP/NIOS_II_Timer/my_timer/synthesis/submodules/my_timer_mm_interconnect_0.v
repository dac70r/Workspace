...
`timescale 1 ps / 1 ps
module my_timer_mm_interconnect_0 (
		...
		output wire [0:0]  timerr_control_slave_address,                   //                     timerr_control_slave.address
		input  wire [31:0] timerr_control_slave_readdata                   //                                         .readdata
	);
	...
	wire  [31:0] timerr_control_slave_agent_m0_readdata;                                             // timerr_control_slave_translator:uav_readdata -> timerr_control_slave_agent:m0_readdata
	wire         timerr_control_slave_agent_m0_waitrequest;                                          // timerr_control_slave_translator:uav_waitrequest -> timerr_control_slave_agent:m0_waitrequest
	wire         timerr_control_slave_agent_m0_debugaccess;                                          // timerr_control_slave_agent:m0_debugaccess -> timerr_control_slave_translator:uav_debugaccess
	wire  [13:0] timerr_control_slave_agent_m0_address;                                              // timerr_control_slave_agent:m0_address -> timerr_control_slave_translator:uav_address
	wire   [3:0] timerr_control_slave_agent_m0_byteenable;                                           // timerr_control_slave_agent:m0_byteenable -> timerr_control_slave_translator:uav_byteenable
	wire         timerr_control_slave_agent_m0_read;                                                 // timerr_control_slave_agent:m0_read -> timerr_control_slave_translator:uav_read
	wire         timerr_control_slave_agent_m0_readdatavalid;                                        // timerr_control_slave_translator:uav_readdatavalid -> timerr_control_slave_agent:m0_readdatavalid
	wire         timerr_control_slave_agent_m0_lock;                                                 // timerr_control_slave_agent:m0_lock -> timerr_control_slave_translator:uav_lock
	wire  [31:0] timerr_control_slave_agent_m0_writedata;                                            // timerr_control_slave_agent:m0_writedata -> timerr_control_slave_translator:uav_writedata
	wire         timerr_control_slave_agent_m0_write;                                                // timerr_control_slave_agent:m0_write -> timerr_control_slave_translator:uav_write
	wire   [2:0] timerr_control_slave_agent_m0_burstcount;                                           // timerr_control_slave_agent:m0_burstcount -> timerr_control_slave_translator:uav_burstcount
	wire         timerr_control_slave_agent_rf_source_valid;                                         // timerr_control_slave_agent:rf_source_valid -> timerr_control_slave_agent_rsp_fifo:in_valid
	wire  [90:0] timerr_control_slave_agent_rf_source_data;                                          // timerr_control_slave_agent:rf_source_data -> timerr_control_slave_agent_rsp_fifo:in_data
	wire         timerr_control_slave_agent_rf_source_ready;                                         // timerr_control_slave_agent_rsp_fifo:in_ready -> timerr_control_slave_agent:rf_source_ready
	wire         timerr_control_slave_agent_rf_source_startofpacket;                                 // timerr_control_slave_agent:rf_source_startofpacket -> timerr_control_slave_agent_rsp_fifo:in_startofpacket
	wire         timerr_control_slave_agent_rf_source_endofpacket;                                   // timerr_control_slave_agent:rf_source_endofpacket -> timerr_control_slave_agent_rsp_fifo:in_endofpacket
	wire         timerr_control_slave_agent_rsp_fifo_out_valid;                                      // timerr_control_slave_agent_rsp_fifo:out_valid -> timerr_control_slave_agent:rf_sink_valid
	wire  [90:0] timerr_control_slave_agent_rsp_fifo_out_data;                                       // timerr_control_slave_agent_rsp_fifo:out_data -> timerr_control_slave_agent:rf_sink_data
	wire         timerr_control_slave_agent_rsp_fifo_out_ready;                                      // timerr_control_slave_agent:rf_sink_ready -> timerr_control_slave_agent_rsp_fifo:out_ready
	wire         timerr_control_slave_agent_rsp_fifo_out_startofpacket;                              // timerr_control_slave_agent_rsp_fifo:out_startofpacket -> timerr_control_slave_agent:rf_sink_startofpacket
	wire         timerr_control_slave_agent_rsp_fifo_out_endofpacket;                                // timerr_control_slave_agent_rsp_fifo:out_endofpacket -> timerr_control_slave_agent:rf_sink_endofpacket
	wire         cmd_mux_001_src_valid;                                                              // cmd_mux_001:src_valid -> timerr_control_slave_agent:cp_valid
	wire  [89:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> timerr_control_slave_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                              // timerr_control_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [5:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> timerr_control_slave_agent:cp_channel
	wire         cmd_mux_001_src_startofpacket;                                                      // cmd_mux_001:src_startofpacket -> timerr_control_slave_agent:cp_startofpacket
	wire         cmd_mux_001_src_endofpacket;                                                        // cmd_mux_001:src_endofpacket -> timerr_control_slave_agent:cp_endofpacket
	...
	wire  [89:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> timer_0_s1_agent:cp_data
	...
	wire         timerr_control_slave_agent_rp_valid;                                                // timerr_control_slave_agent:rp_valid -> router_003:sink_valid
	wire  [89:0] timerr_control_slave_agent_rp_data;                                                 // timerr_control_slave_agent:rp_data -> router_003:sink_data
	wire         timerr_control_slave_agent_rp_ready;                                                // router_003:sink_ready -> timerr_control_slave_agent:rp_ready
	wire         timerr_control_slave_agent_rp_startofpacket;                                        // timerr_control_slave_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire         timerr_control_slave_agent_rp_endofpacket;                                          // timerr_control_slave_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [89:0] timer_0_s1_agent_rp_data;                                                           // timer_0_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [89:0] cmd_demux_001_src0_data;                                                            // cmd_demux_001:src0_data -> cmd_mux_002:sink1_data
	...
	wire  [89:0] rsp_demux_002_src1_data;                                                            // rsp_demux_002:src1_data -> rsp_mux_001:sink0_data
	...
	wire         timerr_control_slave_agent_rdata_fifo_src_valid;                                    // timerr_control_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] timerr_control_slave_agent_rdata_fifo_src_data;                                     // timerr_control_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         timerr_control_slave_agent_rdata_fifo_src_ready;                                    // avalon_st_adapter_001:in_0_ready -> timerr_control_slave_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_001_out_0_valid;                                                  // avalon_st_adapter_001:out_0_valid -> timerr_control_slave_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_001_out_0_data;                                                   // avalon_st_adapter_001:out_0_data -> timerr_control_slave_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_001_out_0_ready;                                                  // timerr_control_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire   [0:0] avalon_st_adapter_001_out_0_error;                                                  // avalon_st_adapter_001:out_0_error -> timerr_control_slave_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) timerr_control_slave_translator (
		.clk                    (clk_0_clk_clk),                                 //                      clk.clk
		.reset                  (jtag_uart_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (timerr_control_slave_agent_m0_address),         // avalon_universal_slave_0.address
		.uav_burstcount         (timerr_control_slave_agent_m0_burstcount),      //                         .burstcount
		.uav_read               (timerr_control_slave_agent_m0_read),            //                         .read
		.uav_write              (timerr_control_slave_agent_m0_write),           //                         .write
		.uav_waitrequest        (timerr_control_slave_agent_m0_waitrequest),     //                         .waitrequest
		.uav_readdatavalid      (timerr_control_slave_agent_m0_readdatavalid),   //                         .readdatavalid
		.uav_byteenable         (timerr_control_slave_agent_m0_byteenable),      //                         .byteenable
		.uav_readdata           (timerr_control_slave_agent_m0_readdata),        //                         .readdata
		.uav_writedata          (timerr_control_slave_agent_m0_writedata),       //                         .writedata
		.uav_lock               (timerr_control_slave_agent_m0_lock),            //                         .lock
		.uav_debugaccess        (timerr_control_slave_agent_m0_debugaccess),     //                         .debugaccess
		.av_address             (timerr_control_slave_address),                  //      avalon_anti_slave_0.address
		.av_readdata            (timerr_control_slave_readdata),                 //                         .readdata
		.av_write               (),                                              //              (terminated)
		.av_read                (),                                              //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) timerr_control_slave_agent (
		.clk                     (clk_0_clk_clk),                                         //             clk.clk
		.reset                   (jtag_uart_0_reset_reset_bridge_in_reset_reset),         //       clk_reset.reset
		.m0_address              (timerr_control_slave_agent_m0_address),                 //              m0.address
		.m0_burstcount           (timerr_control_slave_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (timerr_control_slave_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (timerr_control_slave_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (timerr_control_slave_agent_m0_lock),                    //                .lock
		.m0_readdata             (timerr_control_slave_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (timerr_control_slave_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (timerr_control_slave_agent_m0_read),                    //                .read
		.m0_waitrequest          (timerr_control_slave_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (timerr_control_slave_agent_m0_writedata),               //                .writedata
		.m0_write                (timerr_control_slave_agent_m0_write),                   //                .write
		.rp_endofpacket          (timerr_control_slave_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (timerr_control_slave_agent_rp_ready),                   //                .ready
		.rp_valid                (timerr_control_slave_agent_rp_valid),                   //                .valid
		.rp_data                 (timerr_control_slave_agent_rp_data),                    //                .data
		.rp_startofpacket        (timerr_control_slave_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (timerr_control_slave_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (timerr_control_slave_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (timerr_control_slave_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (timerr_control_slave_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (timerr_control_slave_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (timerr_control_slave_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (timerr_control_slave_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (timerr_control_slave_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (timerr_control_slave_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (timerr_control_slave_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_001_out_0_ready),                     // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_001_out_0_valid),                     //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_001_out_0_data),                      //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_001_out_0_error),                     //                .error
		.rdata_fifo_src_ready    (timerr_control_slave_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (timerr_control_slave_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (timerr_control_slave_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                                 //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                   //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) timerr_control_slave_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                         //       clk.clk
		.reset             (jtag_uart_0_reset_reset_bridge_in_reset_reset),         // clk_reset.reset
		.in_data           (timerr_control_slave_agent_rf_source_data),             //        in.data
		.in_valid          (timerr_control_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (timerr_control_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (timerr_control_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (timerr_control_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (timerr_control_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (timerr_control_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (timerr_control_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (timerr_control_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (timerr_control_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                 // (terminated)
		.csr_read          (1'b0),                                                  // (terminated)
		.csr_write         (1'b0),                                                  // (terminated)
		.csr_readdata      (),                                                      // (terminated)
	...
	my_timer_mm_interconnect_0_router router (
	...
	my_timer_mm_interconnect_0_router_001 router_001 (
	...
	my_timer_mm_interconnect_0_router_002 router_002 (
	...
	my_timer_mm_interconnect_0_router_002 router_003 (
		.sink_ready         (timerr_control_slave_agent_rp_ready),           //      sink.ready
		.sink_valid         (timerr_control_slave_agent_rp_valid),           //          .valid
		.sink_data          (timerr_control_slave_agent_rp_data),            //          .data
		.sink_startofpacket (timerr_control_slave_agent_rp_startofpacket),   //          .startofpacket
		.sink_endofpacket   (timerr_control_slave_agent_rp_endofpacket),     //          .endofpacket
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	my_timer_mm_interconnect_0_router_004 router_004 (
	...
	my_timer_mm_interconnect_0_router_004 router_005 (
	...
	my_timer_mm_interconnect_0_router_002 router_006 (
	...
	my_timer_mm_interconnect_0_router_002 router_007 (
	...
	my_timer_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	my_timer_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	my_timer_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	my_timer_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	my_timer_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	my_timer_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	my_timer_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	my_timer_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	my_timer_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	my_timer_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	my_timer_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	my_timer_mm_interconnect_0_cmd_demux_001 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	my_timer_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	my_timer_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	my_timer_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	my_timer_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	my_timer_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	my_timer_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                   // in_clk_0.clk
		.in_rst_0_reset (jtag_uart_0_reset_reset_bridge_in_reset_reset),   // in_rst_0.reset
		.in_0_data      (timerr_control_slave_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (timerr_control_slave_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (timerr_control_slave_agent_rdata_fifo_src_ready), //         .ready
