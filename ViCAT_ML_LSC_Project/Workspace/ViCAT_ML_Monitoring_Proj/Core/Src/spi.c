...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PB5     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, ESC_SPI_CLK_Pin|ESC_SPI_MISO_Pin);

    HAL_GPIO_DeInit(ESC_SPI_MOSI_GPIO_Port, ESC_SPI_MOSI_Pin);
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PB15     ------> SPI2_MOSI
    */
    HAL_GPIO_DeInit(GPIOB, ADC_SPI_CS_Pin|ADC_SPI_SCK_Pin|ADC_SPI_MISO_Pin|ADC_SPI_MOSI_Pin);
  ...
  /* USER CODE END SPI3_MspDeInit 0 */
    ...
    PC12     ------> SPI3_MOSI
    */
    HAL_GPIO_DeInit(GPIOC, ESC_SPI_SCK_2_Pin|ESC_SPI_MISO_2_Pin|ESC_SPI_MOSI_2_Pin);
