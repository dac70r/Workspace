...
#define HW_EEPROM_PORT ESC_EEP_DONE_Pin
#define HW_EEPROM_PIN ESC_EEP_DONE_GPIO_Port
...
#define HW_TIMETASK_INSTANCE_H htim7
...
uint8_t ADS131A04_wait_drdy_int(const uint32_t timeout_10ms);
