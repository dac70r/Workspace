// nios_interrupt_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module nios_interrupt_mm_interconnect_0 (
	...
	wire  [91:0] cmd_mux_002_src_data;                                                       // cmd_mux_002:src_data -> NIOS_debug_mem_slave_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                      // NIOS_debug_mem_slave_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [3:0] cmd_mux_002_src_channel;                                                    // cmd_mux_002:src_channel -> NIOS_debug_mem_slave_agent:cp_channel
	...
	wire  [91:0] nios_debug_mem_slave_agent_rp_data;                                         // NIOS_debug_mem_slave_agent:rp_data -> router_004:sink_data
	...
	nios_interrupt_mm_interconnect_0_router router (
	...
	nios_interrupt_mm_interconnect_0_router_001 router_001 (
	...
	nios_interrupt_mm_interconnect_0_router_002 router_002 (
	...
	nios_interrupt_mm_interconnect_0_router_002 router_003 (
	...
	nios_interrupt_mm_interconnect_0_router_004 router_004 (
	...
	nios_interrupt_mm_interconnect_0_router_004 router_005 (
	...
	nios_interrupt_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_interrupt_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_interrupt_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_interrupt_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (sysid_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_interrupt_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_interrupt_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (sysid_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_interrupt_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_interrupt_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (sysid_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_interrupt_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_interrupt_mm_interconnect_0_cmd_demux_001 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (sysid_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_interrupt_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_interrupt_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
