...
HD_PWD='C:/Users/denni/Documents/Code/Basys3/debouncing_ciruit/debouncing_ciruit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log debouncing.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source debouncing.tcl
