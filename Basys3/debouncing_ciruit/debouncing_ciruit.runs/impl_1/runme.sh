...
HD_PWD='C:/Users/denni/Documents/Code/Basys3/debouncing_ciruit/debouncing_ciruit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log debouncing.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source debouncing.tcl -notrace
