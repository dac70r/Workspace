...
HD_PWD='C:/Users/denni/Documents/Code/Basys3/two_to_one_mux/two_to_one_mux.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log two_to_one_mux.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source two_to_one_mux.tcl -notrace
