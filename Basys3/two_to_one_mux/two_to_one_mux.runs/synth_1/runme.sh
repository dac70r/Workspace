...
HD_PWD='C:/Users/denni/Documents/Code/Basys3/two_to_one_mux/two_to_one_mux.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log two_to_one_mux.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source two_to_one_mux.tcl
