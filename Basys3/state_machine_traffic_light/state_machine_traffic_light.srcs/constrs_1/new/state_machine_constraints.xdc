...
set_property PACKAGE_PIN A14 [get_ports {main_str[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {main_str[0]}]
#Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports {main_str[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {main_str[1]}]
#Sch name = JB3
set_property PACKAGE_PIN B15 [get_ports {main_str[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {main_str[2]}]
##Sch name = JB4
...
set_property PACKAGE_PIN K17 [get_ports {cross_str[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {cross_str[0]}]
#Sch name = JC2
set_property PACKAGE_PIN M18 [get_ports {cross_str[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {cross_str[1]}]
#Sch name = JC3
set_property PACKAGE_PIN N17 [get_ports {cross_str[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {cross_str[2]}]
##Sch name = JC4
